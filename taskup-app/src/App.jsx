...
export default function App() {
  const [tabs, setTabs] = useState(loadData);
  ...
  const addTab = () => {
    ...
    const newTabs = [...tabs, { id, label: name, color, subtabs: [], tasks: [], reminders: [] }];
    updateTabs(newTabs);
  ...
  const addSubtab = () => {
    ...
    if (!name) return;
    const id = uid();
    updateTabs(tabs.map(t => t.id === activeTab
